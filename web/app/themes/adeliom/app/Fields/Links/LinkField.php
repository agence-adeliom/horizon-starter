...
class LinkField
{
    ...
    public const string VALUE_TYPE_INTERNAL = 'internal';
    public const string VALUE_TYPE_EXTERNAL = 'external';

    public const string FIELD_POST = 'post';
    public const string FIELD_POST_LABEL = 'label';
    public const string FIELD_EXTERNAL_LINK = 'link';
    public const string FIELD_IS_TARGET_BLANK = 'is-target-blank';
